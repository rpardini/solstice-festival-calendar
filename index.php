...
if (@strlen($_REQUEST['stage']) > 1) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            window.fakeTimeForNow = <?= (@!$_REQUEST['fake']) ? "null" : 1718452800 + (60 * 60 * 3) ?>;
    ...
    <header>
        <div class="logo">
            <img id="logo" src="<?= cacheBusterLink("img/logo.main.png") ?>" width="400" height="462"
                 loading="eager"
    ...
    <section id="timetable">
        ...
        <div class="container">
            ...
            <a class="button button--weather" href="https://www.buienradar.nl/weer/Halfweg/NL/100001059/14daagse" target="buien"> Weather </a>
            <a class="button button--map" href="https://www.google.com/maps/place/Ruigoord 76, 1047 HH Amsterdam" target="gmaps"> Festival Map </a>
